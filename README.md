...
If you only need the test results, you can use the following code:

``` r
covTest.multi(chart, species)
```

若需要输出全部结果，记得设置`full = TRUE`.

If you need to output all the results, remember to set `full = TRUE`.
